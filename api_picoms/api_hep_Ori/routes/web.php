...
$router->get('/hepCounselling/generatePDF', 'hep_counsellingController@generatePDF'); //afiez utk generate PDF
...
$router->post('/hepHostelChkinout/reporting/reportBaitulMal', 'hep_hostel_checkInOutController@reportBaitulMal'); 
